...
\usepackage[top=25mm, bottom=25mm, inner=20mm, outer=20mm]{geometry} % inner larger for binding (cucitura)
...
\usepackage{placeins} % for \FloatBarrier (keeps floats from drifting too far)
