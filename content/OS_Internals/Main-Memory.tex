...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/memory.png}
    \caption{Le memorie in sintesi: prezzi e latenze superiori al 2024}
\end{figure}
...
\paragraph{Località temporale:} La località temporale significa che se leggo una variabile, la probabilità di riutilizzarla è alta; pertanto la mantengo nella memoria cache.


\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{content/OS_Internals/img/spatial.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\linewidth]{content/OS_Internals/img/adsfcv.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/ikadsuhc.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\linewidth]{content/OS_Internals/img/rwefbg.png}
    \caption{Elaborazione in più fasi di un programma utente}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/hnter.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/mmuu.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.55\linewidth]{content/OS_Internals/img/ddl.png}
    \caption{File .dll}
\end{figure}
...
I registri di rilocazione vengono utilizzati per proteggere i processi utente l'uno dall'altro e per impedire modifiche al codice e ai dati del sistema operativo:
...
\end{itemize}
 ...
 \begin{figure}[htbp]
     \centering
     \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/fbs.png}
 \end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/jyrt.png}
\end{figure}
...
\begin{itemize}
    \item First-fit: Alloca il primo buco sufficientemente grande
    \begin{itemize}
        \item[] Può produrre molti piccoli buchi residui
    \end{itemize}

    \item Best-fit: Alloca il buco più piccolo sufficientemente grande; deve scorrere l'intera lista, salvo che sia ordinata per dimensione

    \begin{itemize}
        \item[] Produce il buco residuo più piccolo, che potrebbe non essere più riempito.
    \end{itemize}

    \item Worst-fit: Alloca il buco più grande; deve anch'esso scorrere l'intera lista
    \begin{itemize}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/mkjhg.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/mht.png}
\end{figure}
...
\paragraph{NOTA: } a questo punto è indifferente parlare di SSD o RAM, è la stessa cosa; cambiano solo la latenza e la volatilità.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\linewidth]{content/OS_Internals/img/yuj,.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/nfg.png}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/dsf.png}
    \caption{Modello di paginazione della memoria logica e fisica}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/jmy.png}
\end{figure}


\paragraph{Paginazione - Calcolo della frammentazione interna}
\paragraph{}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{content/OS_Internals/img/yrtjn.png}
    \caption{Frame liberi}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/ythmu.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/bnetg.png}
    \caption{Page fault}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/frsb.png}
    \caption{Page fault}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/rfynhmg.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/mhg.png}
\end{figure}
...
\begin{itemize}
    \centering 
    \item[] EAT = (1 - p) × accesso in memoria + p (overhead page fault)
\end{itemize}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/rhsbgfw.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/sdfbgv.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/mghj.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/andg.png}
    \caption{Esempio di recupero delle pagine}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/SDBF.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/fmh.png}
    \caption{PFF}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/dfbngt.png}
    \caption{Processo di swapping}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{content/OS_Internals/img/ndgf.png}
    \caption{Swapping con paginazione}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/OS_internals/Main-memory/MM-esempio1.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/sbdf.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/mu.png}
\end{figure}


\subsubsection{Spazio di Indirizzamento Logico a 64 bit}

Anche uno schema di paginazione a due livelli potrebbe non essere sufficiente; se la dimensione della pagina è ancora 4 KB, la tabella delle pagine ha $2^{52}$ voci e le tabelle delle pagine interne potrebbero essere $2^{10}$:

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/ndg.png}
\end{figure}

La tabella delle pagine esterna ha $2^{42}$ voci, ovvero 4 terabyte per processo! Una soluzione potrebbe essere aggiungere un ulteriore livello di tabella delle pagine esterna:

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/db.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/ngf.png}
    \caption{Tabella delle pagine con hashing}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/sfb.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/sdavg.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/dgn.png}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/dasv.png}
    \caption{Segmentazione: da logico a fisico}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{content/OS_Internals/img/dsfb.png}
\end{figure}

\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/Immagine 2024-05-22 170639.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{content/OS_Internals/img/dddbv.png}
    \caption{Conversione degli indirizzi di memoria}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.55\linewidth]{content/OS_Internals/img/abdv.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{content/OS_Internals/img/fmhh.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{images/OS_internals/Main-memory/MM-esempio3.png}
    \caption{Architettura ARM}
\end{figure}
