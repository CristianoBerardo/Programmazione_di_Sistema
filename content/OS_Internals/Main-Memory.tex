...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\linewidth]{content/OS_Internals/images/2026-03-30-12-25-13.png}
\end{figure}
...
\begin{center}
  ...
  \begin{minipage}{0.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/2026-03-31-13-35-34.png}
  \end{minipage}
\end{center}
...
\begin{center}
  \begin{equation*}
    \text{Page Fault} = f(m, A, s) \quad \text{Dove: m è il page size, A è l'algoritmo di sostituzione e s è la stringa di riferimento} 
  \end{equation*}
\end{center}
