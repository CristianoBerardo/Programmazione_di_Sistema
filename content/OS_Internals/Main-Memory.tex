...
\begin{center}
  \begin{minipage}{1\linewidth}
    ...
    \begin{minipage}{0.3\linewidth}
      ...
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/adsfcv.png}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \hfill
    \begin{minipage}{0.3\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/ikadsuhc.png}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.2\linewidth}
      \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/rwefbg.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \hfill
    \begin{minipage}{0.25\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/hnter.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \hfill
    \begin{minipage}{0.25\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/mmuu.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.35\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/ddl.png}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \hfill
    \begin{minipage}{0.35\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/fbs.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.6\linewidth}
      ...
      Quando un processo arriva, gli viene allocata memoria da un buco sufficientemente
      grande da contenerlo; quando un processo termina e libera la sua partizione,
      le partizioni libere adiacenti vengono unite. Tutto ciò è gestito dal sistema
      operativo che mantiene informazioni su: partizioni allocate e partizioni libere (buchi)

    \end{minipage}% <-- IMPORTANTE: il simbolo % qui evita spazi bianchi extra
    \hfill
    \begin{minipage}{0.35\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/jyrt.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.25\linewidth]{content/OS_Internals/img/jmy.png}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\linewidth]{images/OS_internals/Main-memory/MM-esempio4.png}
\end{figure}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.37\linewidth}
      \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/ythmu.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \hfill
    \begin{minipage}{0.37\linewidth}
      \includegraphics[width=0.8\linewidth]{content/OS_Internals/img/frsb.png}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.25\linewidth}
      ...
      \vspace{0.5cm}
      \includegraphics[width=0.75\linewidth]{images/OS_internals/Main-memory/MM-esempio7.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{0.85\linewidth}
    \begin{minipage}{0.47\linewidth}
      \includegraphics[width=0.75\linewidth]{images/OS_internals/Main-memory/MM-esempio9.png}


    \end{minipage}% <-- IMPORTANTE: il simbolo % qui evita spazi bianchi extra
    \hfill
    \begin{minipage}{0.47\linewidth}
      \includegraphics[width=0.75\linewidth]{images/OS_internals/Main-memory/MM-esempio10.png}
...
\begin{minipage}{1\linewidth}
  ...
  \hfill
  \begin{minipage}{0.36\linewidth}
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/ahet.png}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{content/OS_Internals/img/jnyfg.png}
  \end{minipage}
\end{flushleft}
...
\begin{center}
  ...
  \begin{minipage}{0.45\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/images/2026-03-31-13-35-34.png}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{0.45\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{images/OS_internals/Main-memory/MM-esempio13.png}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{1\linewidth}
    ...
    \hfill
    \begin{minipage}{0.3\linewidth}
      \includegraphics[width=0.75\linewidth]{images/OS_internals/Main-memory/MM-esempio14.png}
...
\begin{center}
  ...
  \begin{minipage}{1\linewidth}
    ...
    \hfill
    \begin{minipage}{0.25\linewidth}
      \includegraphics[width=0.5\textwidth]{images/OS_internals/Main-memory/MM-esempio16.png}
    \end{minipage}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.25\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/sbdf.png}

    \includegraphics[width=0.75\linewidth]{content/OS_Internals/img/mu.png}
  \end{minipage}
\end{flushleft}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.3\linewidth]{content/OS_Internals/img/Immagine 2024-05-22 170639.png}
\end{figure}
...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.4\linewidth}
      \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/dddbv.png}

      \captionof{figure}{Conversione degli indirizzi di memoria}

      \vspace{0.1cm}

      \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/abdv.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\linewidth]{content/OS_Internals/img/fmhh.png}
\end{figure}
