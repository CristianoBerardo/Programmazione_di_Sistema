...
il debug con \verb|ddd --debugger mips-harvard-os161-gdb kernel|.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.4\linewidth]{content/OS_Internals/images/2026-05-31-15-37-48.png}
\end{figure}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/images/2026-05-31-16-10-30.png}5  \end{minipage}
\end{flushleft}
