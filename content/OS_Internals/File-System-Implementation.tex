...
\begin{minipage}{0.2\textwidth}
  \begin{center}
    ...
    \captionof{figure}{Struttura che contiene solo il puntatore}
  \end{center}
\end{minipage}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/OS_Internals/images/2026-05-22-10-19-09.png}  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=1\linewidth]{content/OS_Internals/images/2026-05-22-10-24-56.png}
  \end{minipage}
\end{center}
