...
\begin{center}
  \begin{minipage}[t]{0.45\linewidth}
    ...
    \centering
    \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/andfg.png}
    \captionof{figure}{Accesso sequenziale}
  \end{minipage}%
  \hfill
  \begin{minipage}[t]{0.45\linewidth}
    ...
    \captionof{figure}{Accesso diretto}
  \end{minipage}
\end{center}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.25\linewidth]{content/OS_Internals/img/dfgnb.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.25\linewidth]{content/OS_Internals/img/fng.png}
...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    {\centering
      \includegraphics[width=0.5\linewidth]{content/OS_Internals/img/dngf.png}
      \par}
  \end{minipage}%
  \hfill
  \begin{minipage}[t]{0.48\linewidth}
