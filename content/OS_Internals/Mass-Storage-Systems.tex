...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.4\linewidth]{content/OS_Internals/img/amrjkyt.png}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{content/OS_Internals/img/tdmng.png}
