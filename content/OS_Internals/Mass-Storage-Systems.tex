...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/2026-03-22-16-53-48.png}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/2026-03-22-17-19-31.png}
  \end{minipage}
\end{center}
...
\begin{equation*}
  \text{MTTF(1st_fail) = MTTF/2 = 100,000/2 = 50,000 hours}
  \text{Prob(2nd_fail_during_repair) = MTTR/MTTF = 10/100,000 = 10-4}

  \text{Tempo medio alla perdita di dati = MTTF(1st_fail+2nd_fail_during_repair)}

  \text{MTTF(fail+fail_during_repair) = MTTF(1st_fail) /Prob(2nd_fail_during_repair) = MTTF2/(2*MTTR) = 1010/(2*10) = 5*108 hours or 57,000 years!}
\end{equation*}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/2026-03-22-17-32-18.png}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/2026-03-22-17-32-56.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\linewidth]{images/2026-03-22-17-53-56.png}
\end{figure}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/2026-03-22-18-06-47.png}
  \end{minipage}
\end{center}
