...
\begin{center}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.3\linewidth}
      ...
      \centering
      \includegraphics[width=0.8\linewidth]{images/API_Programming/Memoria/Memoria-esempio7.png}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{images/API_Programming/Memoria/Memoria-esempio6.png}
    \captionof{figure}{Località}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{images/API_Programming/Memoria/Memoria-esempio1.png}
  \end{minipage}
\end{center}
...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.75\linewidth]{images/API_Programming/Memoria/Memoria-esempio2.png}

      \vspace{0.2cm}

      \includegraphics[width=0.75\linewidth]{images/API_Programming/Memoria/Memoria-esempio5.png}
...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.75\linewidth]{images/API_Programming/Memoria/Memoria-esempio3.png}

      \vspace{0.2cm}

      \includegraphics[width=0.75\linewidth]{images/API_Programming/Memoria/Memoria-esercizio4.png}
