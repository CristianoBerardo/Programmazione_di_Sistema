...
\end{minipage}% <-- IMPORTANTE: il simbolo % qui evita spazi bianchi extra
  ...
  \begin{minipage}{0.3\linewidth}
    ...
    \includegraphics[width=1\linewidth]{images/API_Programming/Memoria/Memoria-esempio7.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\linewidth]{images/API_Programming/Memoria/Memoria-esempio6.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\linewidth]{images/API_Programming/Memoria/Memoria-esempio1.png}
\end{figure}
