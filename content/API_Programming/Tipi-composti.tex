...
Se è parziale la si può utilizzare solo alla fine: \mintinline[breaklines]{rust}{let s1 = Player {name: “Paolo”.to_string(), ..s}}

Se è totale: \mintinline[breaklines]{rust}{let s1 = Player {..s}}
...
\end{minted}
    ...
    \begin{minipage}{\linewidth}
      \begin{minipage}{0.35\linewidth}
        ...
        \includegraphics[width=0.75\linewidth]{images/API_Programming/Tipi-Composti/TC-esempio2.png}
...
\begin{minted}[breaklines]{rust}
pub fn make_filter (filter: Option<String>) -> anyhow::Result<String> {
  if let None = filter {
          return Ok("default_column_name".to_string());
  }else if let Some(column) = filter {
