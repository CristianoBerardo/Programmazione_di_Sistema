...
\begin{tcolorbox}
  \textbf{Nota: } \texttt{no\_mangle} dice al compilatore rust di
  non modificare il nome della funzione durante la compilazione, rendendolo così
  accessibile da altri linguaggi con il nome esatto specificato nel codice
  sorgente. Altrimenti, il compilatore potrebbe applicare name mangling, una
  tecnica che modifica i nomi delle funzioni per includere informazioni aggiuntive
  come ad esempio i tipi dei parametri ad esempio \texttt{add\_i32\_i32}.
\end{tcolorbox}
