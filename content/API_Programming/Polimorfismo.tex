...
\begin{center}
  \begin{minipage}{0.45\linewidth}
    ...
    ale costrutto è separato da quello relativo all'implementazione dei
...
\begin{flushleft}
  \begin{minipage}{0.65\linewidth}
    ...
    \begin{itemize}
      ...
      \item è confrontabile con sé stesso.
...
Il tratto \textbf{FromStr} permette di gestire la conversione da stringa el'eventuale
