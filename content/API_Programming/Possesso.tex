...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.75\linewidth]{images/API_Programming/Possesso/Possesso-esempio5.png}

      \vspace{0.1cm}

      \includegraphics[width=0.75\linewidth]{images/API_Programming/Possesso/Possesso-esempio6.png}
...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.75\linewidth]{images//API_Programming//Possesso/Possesso-esempio8.png}

      \vspace{0.1cm}

      \includegraphics[width=0.75\linewidth]{images//API_Programming//Possesso/Possesso-esempio9.png}
...
let r1: &i32 = &i;
    ...
    \begin{minipage}[c]{0.30\linewidth} % Colonna Immagine (40%)
      \centering
      \includegraphics[width=0.75\linewidth]{images/API_Programming/Possesso/Possesso-esempio13.png}
...
let r2: &[i32] = &a;
    ...
    \begin{minipage}[c]{0.40\linewidth}
      \centering
      \includegraphics[width=0.75\linewidth]{images/API_Programming/Possesso/Possesso-esempio14.png}
