...
\begin{figure}
  \centering
  \includegraphics[width=0.65\linewidth]{images/API_Programming/Possesso/Possesso-esempio3.png}
\end{figure}
...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.65\linewidth]{images/API_Programming/Possesso/Possesso-esempio5.png}

      \vspace{0.1cm}

      \includegraphics[width=0.65\linewidth]{images/API_Programming/Possesso/Possesso-esempio6.png}
...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.75\linewidth]{images//API_Programming//Possesso/Possesso-esempio7.png}
...
\end{minted}
    ...
    \begin{minipage}{0.40\linewidth}
      \centering
      \includegraphics[width=0.65\linewidth]{images//API_Programming//Possesso/Possesso-esempio8.png}

      \vspace{0.1cm}

      \includegraphics[width=0.65\linewidth]{images//API_Programming//Possesso/Possesso-esempio9.png}
...
\begin{flushleft}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images//API_Programming//Possesso/Possesso-esempio10.png}
  \end{minipage}
\end{flushleft}
...
let r1: &i32 = &i;
    ...
    \begin{minipage}[c]{0.30\linewidth} % Colonna Immagine (40%)
      \centering
      \includegraphics[width=0.65\linewidth]{images/API_Programming/Possesso/Possesso-esempio13.png}
...
let r2: &[i32] = &a;
    ...
    \begin{minipage}[c]{0.40\linewidth}
      \centering
      \includegraphics[width=0.65\linewidth]{images/API_Programming/Possesso/Possesso-esempio14.png}
...
\begin{itemize}
  \item Nel primo caso si usa un solo identificatore per identifcare l'intersezione dei loro tempi di vita\\
        \mintinline{rust}{fn f<'a>(p1: &'a i32, p2:&'a i32) {...}}
...
fn main() {
    let mut v: Vec<&str> = Vec::new();
    {
        ...
        v.push(&s);     //error: `s` does not live long enough. Il tempo di vita di v è limitata alla vita di vita di s.
    }
    println!("{:?}",v);
}
...
\begin{itemize}
  ...
  \item \textbf{Oppure}, possono esistere molti riferimenti immutabili al medesimo valore. Ma fintanto che ne esiste almeno uno, il valore non può essere mutato. Principio del \textit{multiple reader and single writer} presente in molti ambiti dell'informatica.

  \item Tutti i riferimenti, che sono pestiti del valore, devono avere una durata di vita inferiore a quella del valore a cui
        fanno riferimento
...
\begin{center}
  \begin{minipage}{0.65\linewidth}
    ...
    Internamente viene rappresentata come \textbf{fat pointer} una tupla di due elementi, i primi 64 bits puntano al valore della sequenza, mentre i secondi 64 bits indicano il numero di elementi consecutivi. Una slice di elementi T ha tipo [T].

    Una slice \textbf{non possiede}, è un prestito a tutti gli effetti, i dati cui fa riferimento. Questi appartengono sempre ad un'altra variabile, da cui la slice viene derivata. Tutti i valori contenuti sono garantiti essere inizializzati, gli accessi sono verificati in fase di esecuzione.
...
\end{minted}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/API_Programming/Possesso/Possesso-slice.png}
  \end{minipage}
\end{center}
...
\begin{flushleft}
  \begin{minipage}{0.65\linewidth}
    ...
    \begin{itemize}
      ...
      \item Poiché in ogni istante il borrow checker è in grado di determinare la dimensione di un blocco di memoria cui un riferimento punta, vedi le slice, non possono verificarsi \textbf{buffer overflow} né \textbf{buffer underflow}
  ...
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/API_Programming/Possesso/Possesso-disposizione-in-memoria.png}
  \end{minipage}
\end{flushleft}
