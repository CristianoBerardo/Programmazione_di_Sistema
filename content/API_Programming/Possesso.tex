...
\end{center}
 ...
 \begin{itemize}
     ...
     \item Accessi in \textbf{scrittura}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/API_Programming/Possesso/Possesso-esempio3.png}
\end{figure}
...
Una variabile locale è SEMPRE allocata sullo stack. Questo si estende di una quantità pari alla dimensione del valore che deve essere memorizzato nella variabile. Quando la variabile esce dal proprio scope sintattico, lo stack di contrae ed il valore viene rilasciato.
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images//API_Programming//Possesso/Possesso-esempio10.png}
\end{figure}
...
\begin{itemize}
    \item Puntatori semplici, se il compratole conosce la dimensione del dato puntato
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/API_Programming/Possesso/Possesso-slice.png}
\end{figure}
